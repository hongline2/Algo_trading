...
class Portfolio(object):
    ...
    def create_equity_curve_dataframe(self):
        ...
        curve.set_indeX('datatime',inplace=True)
        curve['returns']=curve['total'].pct_change()
        curve['equity_curve']=(1.0+curve['returns']).cumpord()
    ...
    def output_summary_stats(self):
        ...
        stats=[('Total return','%0.2f%%'%((total_return-1.0)*100)),('sharp ratio','%0.2f'%sharp_ratio),('max drawdwon','%0.2f'%(max_dd*100)),('drawdwon duration','%d'%dd_duration)]
